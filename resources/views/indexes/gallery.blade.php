...
{{--                    <li class="nav-item"><a class="nav-link active" href="gallery.blade.php">Videos</a></li>--}}
    ...
    <main class="page">
        <section class="clean-block clean-gallery dark">
            <div class="container">
                ...
                <div class="row"><!-- <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/scenery/image1.jpg"><img class="img-thumbnail img-fluid image" src="assets/img/scenery/image1.jpg" /></a>
</div> -->
<div class="col-md-6 col-lg-4 item">
   <video width="356" height="240.655" controls>
  <source src="/home/arsen/Downloads/video.mp4" type="video/mp4">


</video>
</div>
<!-- <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/scenery/image1.jpg"><img class="img-thumbnail img-fluid image" src="assets/img/scenery/image1.jpg" /></a>
</div> -->
<div class="col-md-6 col-lg-4 item">
   <video width="356" height="240.655" controls>
  <source src="/home/arsen/Downloads/video.mp4" type="video/mp4">
